...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("⏸ `Berhenti Sebentar.`")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("__▶️ Dilanjutkan.__")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**⏹ Berhenti memutar musik.**")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("__⏩ Melewati lagu saat ini.__")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("❇️ **Daftar Admin diperbaharui!**")
