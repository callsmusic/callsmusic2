...
async def play(client: Client, message_: Message):
    ...
    res = await message_.reply_text("🔄 __Sedang Memutar Lagu...__")
    ...
    if audio:
        ...
        if offset == None:
            await res.edit_text("**❕ Kamu tidak memberikan apapun untuk saya putar!**")
            return
    ...
    if is_playing:
        ...
        await res.edit_text(f"#️⃣ Ditambahkan Ke Antrian Nomer {position}.")
    else:
        await res.edit_text("▶️ **Lagu Berhasi Diputar...**")
